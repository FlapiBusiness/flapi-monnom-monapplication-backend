# Flapi - monnom MonApplication - BackEnd
...
- Development-Remote : https://dev.monsousdomain2.api.flapi.org
- Staging : https://staging.monsousdomain2.api.flapi.org
- Production : https://monsousdomain2.api.flapi.org
...
```bash
git clone git@github.com:FlapiBusiness/flapi-monnom-MonApplication-backend.git
```
...
- Un fichier **`.env.keys.monsousdomain2`** est fourni pour montrer la structure des clés, sans valeurs réelles.
